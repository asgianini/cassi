...
def grava_municipio(id_uf, cd_municipio, nm_municipio):
    ...
    try:
        con = conecta_banco()
        cursor = con.cursor()
        sql = 'INSERT INTO tb_municipio (id_uf, cd_municipio, nm_municipio) '
        sql += 'VALUES (%s, %s, %s)'
...
def carrega_municipio():
    ...
    for uf in ufs:
        ...
        parametros = {'id_operadora':19, 'id_estado': sg_uf, 'id_plano': id_plano,
        ...
        try:
            ...
            for municipio in municipios:
                ...
                erro, msg_erro = grava_municipio(id_uf, cd_municipio, nm_municipio)              
